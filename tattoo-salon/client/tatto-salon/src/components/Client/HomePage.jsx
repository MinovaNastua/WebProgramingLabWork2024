    ...
    <Col>
        <Card>
            ...
            <Card.Body>
                ...
                {!sketch.isReserved && (
                    <Button className={styles.button}  style={{backgroundColor: '#F2889C', color: '#232227',  marginBottom: '1vw'}} variant="success" onClick={() => onReserve(sketch.id)}>
                        Зарезервировать
                    </Button>
                )}
            </Card.Body>
...
const HomePage = () => {
    ...
    return (
        <Container style={{color: '#F2889C'}}   className="mt-4 home-page">
            <h1 className="mb-4">Добро пожаловать</h1>
            {error && <Alert variant="danger">{error}</Alert>}
            {successMessage && <Alert variant="success">{successMessage}</Alert>}

            <Button
                className={styles.button}  style={{backgroundColor: '#F2889C', color: '#232227',  marginBottom: '1vw', width: '21vw !important'}}
            ...
            {showAppointmentForm && (
                <Form onSubmit={handleAppointmentSubmit} className="mb-4">
                    ...
                    <Button className={styles.button}  style={{backgroundColor: '#F2889C', color: '#232227',  marginBottom: '1vw'}} type="submit" variant="primary">
                        Создать запись на приём
                    </Button>
                </Form>
            )}

            <Tabs className= {styles.tub}
                activeKey={activeKey}
