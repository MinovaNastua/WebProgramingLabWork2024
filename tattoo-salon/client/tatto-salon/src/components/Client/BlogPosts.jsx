...
const BlogPosts = () => {
    ...
    const handleReadMore = (postId) => {
        // Здесь можно использовать history.push для навигации или открывать модальное окно
        console.log('Читать далее для поста с ID:', postId);
        // Например, можно использовать router для навигации на страницу поста
        // history.push(`/blogposts/${postId}`);
    };
    ...
    return (
        <Container style={{color: '#F2889C'}} className="blog-container">
            <Row className="mb-4">
                <Col>
                        ...
                        <Col key={post.id} md={6} lg={4}>
                            <Card className="h-100 shadow-sm">
                                ...
                                <Card.Footer className="d-flex justify-content-between align-items-center">
                                    <Button variant="outline-primary" size="sm" onClick={() => handleReadMore(post.id)}>
                                        Читать далее
                                    </Button>
                                    <div>
                                        <Button
