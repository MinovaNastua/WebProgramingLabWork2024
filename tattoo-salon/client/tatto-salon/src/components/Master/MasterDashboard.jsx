...
const MasterDashboard = () => {
    ...
    return (
        <Container style={{color: '#F2889C'}}  className="mt-4">
            <h1 className="mb-4">Панель мастера</h1>
            <Tabs style={{color: '#F2889C'}}  className= {styles.tub} activeKey={activeKey} onSelect={(k) => setActiveKey(k)}>
                <Tab style={{color: '#F2889C'}}  eventKey="profile" title="Мой профиль">
                    ...
                    {master && (
                        <Form onSubmit={handleProfileSubmit}>
                            ...
                            <Button className={styles.button}  style={{backgroundColor: '#F2889C', color: '#232227',  marginBottom: '1vw'}} variant="primary" type="submit">
                                Обновить профиль
                            </Button>
                        </Form>
                    )}
