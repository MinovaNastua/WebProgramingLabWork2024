...
const SketchManager = () => {
    ...
    return (
        <Container className="mt-4">
            ...
            <Row className="mb-4">
                <Col>
                    <h2 style={{color: '#F2889C'}}>Список эскизов</h2>
                        ...
                        <tbody>
                            {sketches.map((sketch) => (
                                <tr key={sketch.id}>
                                    ...
                                    <td>
                                        <Button variant="primary" size="sm" className={styles.button}  style={{backgroundColor: '#F2889C', color: '#232227',  marginBottom: '1vw'}} onClick={() => handleEdit(sketch)}>
                                            Редактировать
                                        </Button>{' '}
                                        <Button variant="danger" size="sm" className={styles.button}  style={{backgroundColor: '#F2889C', color: '#232227',  marginBottom: '1vw'}} onClick={() => handleDelete(sketch.id)}>
                                            Удалить
                                        </Button>
                                    </td>
                                </tr>
            ...
            <Row>
                <Col md={6}>
                    <h2 style={{color: '#F2889C'}}>{editing ? 'Редактирование эскиза' : 'Создание нового эскиза'}</h2>
                    <Form onSubmit={handleSubmit}>
                        <Form.Group controlId="formTitle">
                            <Form.Label style={{color: '#F2889C'}} >Заголовок</Form.Label>
                            <Form.Control
                                type="text"
                                name="title"
                        ...
                        <Form.Group controlId="formDescription">
                            <Form.Label style={{color: '#F2889C'}} >Описание</Form.Label>
                            <Form.Control
                                as="textarea"
                                rows={3}
                                name="description"
                        ...
                        <Form.Group controlId="formTags">
                            <Form.Label style={{color: '#F2889C'}} >Теги (через запятую)</Form.Label>
                            <Form.Control
                                type="text"
                                name="tags"
                        ...
                        <Form.Group controlId="formImage">
                            <Form.Label style={{color: '#F2889C'}} >Изображение эскиза</Form.Label>
                            <Form.Control
                                type="file"
                                name="imageFile"
                                onChange={handleChange}
                        ...
                        <Button className={styles.button}  style={{backgroundColor: '#F2889C', color: '#232227',  marginBottom: '1vw',  marginTop: '1vw'}} variant="success" type="submit">
                            {editing ? 'Обновить эскиз' : 'Создать эскиз'}
                        </Button>{' '}
                        {editing && (
                            <Button
                            className={styles.button}  style={{backgroundColor: '#F2889C', color: '#232227',  marginBottom: '1vw'}}
                                variant="secondary"
                                onClick={() => {
                                    setEditing(false);
                                    setEditingId(null);
