...
const BlogPostManager = () => {
    ...
    return (
        <Container className="mt-4">
            <Row className="mb-4">
                <Col>
                    <h2 style={{color: '#F2889C'}}>Список записей блога</h2>
                            ...
                            {sortedPosts.map((post) => (
                                <tr key={post.id}>
                                    ...
                                    <td>
                                        ...
                                        <Button className={styles.button}  style={{backgroundColor: '#F2889C', color: '#232227',  marginBottom: '1vw'}}
            ...
            <Row>
                <Col md={6}>
                    <h2 style={{color: '#F2889C'}}>{editing ? 'Редактирование записи' : 'Создание новой записи'}</h2>
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Form.Group controlId="formContent">
                            <Form.Label style={{color: '#F2889C'}} >Контент</Form.Label>
                            <Form.Control
                                as="textarea"
                                rows={3}
                                name="content"
                        ...
                        <Button variant="success" type="submit" className={styles.button}  style={{backgroundColor: '#F2889C', color: '#232227',  marginBottom: '1vw'}}>
